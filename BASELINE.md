...
against. At 1% the same panel gives CAGR 17.75%, alpha +9.28%, t +2.49: inside
the ±1.47% draw-to-draw spread on alpha, so it changes nothing that is claimed
here.
...
Borrow is not what decides this strategy. Alpha holds t +2.63 at 0%, +2.49 at
1%, +2.36 at 2%, and only falls below 2 near **5%** — five times the measured
rate.
